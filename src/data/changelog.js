...
export const CHANGELOG = [
  ...
  },
  {
    ...
    datum: '2026-05-11',
    wijzigingen: [
      'Kauw: literatuurreferenties toegevoegd (11 items incl. Demongin 2016)',
    ],
    wijzigingen_en: [
      'Jackdaw: literature references added (11 items incl. Demongin 2016)',
    ],
    wijzigingen_de: [
      'Dohle: Literaturangaben hinzugefügt (11 Einträge inkl. Demongin 2016)',
    ],
  },
  {
    versie: '1.85.4',
  ...
  },
  {
    ...
    wijzigingen: [
      ...
      'Kauw: geslachts- en leeftijdsnotities, ID-kenmerken, ruitiming, vleugelformule en ondersoorten opmaak gecorrigeerd',
      'package.json: versienummer gesynchroniseerd met changelog',
    ],
    wijzigingen_en: [
      ...
      'Jackdaw: gender/age notes, ID features, moult timing, wing formula and subspecies formatting fixed',
      'package.json: version number synced with changelog',
    ],
    wijzigingen_de: [
      ...
      'Dohle: Formatierung von Geschlechts-/Altersnotizen, ID-Merkmalen, Mauserzeiten, Flügelformel und Unterarten korrigiert',
      'package.json: Versionsnummer mit Changelog synchronisiert',
    ],
  },
  {
    versie: '1.79.0',
  ...
  },
  {
    ...
    wijzigingen_en: [
      ...
      'Species page Ring & Moult: wing formula now displayed as structured table (headers, key-value rows, position lines)',
    ],
    wijzigingen_de: [
      'Artendetailseite Ring & Mauser: "Federstruktur" umbenannt in "Flügelmerkmale" und vor die Flügelformel verschoben',
      'Artendetailseite Ring & Mauser: Flügelformel wird jetzt als strukturierte Tabelle angezeigt',
    ],
  },
  {
    versie: '1.75.0',
  ...
  },
  {
    versie: '1.68.35',
    datum: '2026-04-25',
    wijzigingen: ['Fix: omstandighedenlijst gesorteerd conform Griel-specificatie — code 39 staat nu als laatste optie (na 91)'],
    wijzigingen_en: ['Fix: circumstances list sorted according to Griel specification — code 39 now appears as last option (after 91)'],
    wijzigingen_de: ['Fix: Umstandsliste gemäß Griel-Spezifikation sortiert — Code 39 erscheint jetzt als letzte Option (nach 91)'],
  },
  {
    versie: '1.68.34',
    datum: '2026-04-23',
