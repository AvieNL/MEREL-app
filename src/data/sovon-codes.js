...
export const STADIUM_CODES = [
  { code: 'L0',  groep: 'leeg',       nl: 'L0 — Leeg',                              tKey: 'stad_l0' },
  { code: 'B0',  groep: 'bouw',       nl: 'B0 — Nest bezet',                        tKey: 'stad_b0' },
  { code: 'B1',  groep: 'bouw',       nl: 'B1 — Nestbouw',                          tKey: 'stad_b1' },
  { code: 'B2',  groep: 'bouw',       nl: 'B2 — Begin nestbouw',                    tKey: 'stad_b2' },
  { code: 'B3',  groep: 'bouw',       nl: 'B3 — Nest half klaar',                   tKey: 'stad_b3' },
  { code: 'B4',  groep: 'bouw',       nl: 'B4 — Nest bijna klaar',                  tKey: 'stad_b4' },
  { code: 'B5',  groep: 'bouw',       nl: 'B5 — Nest klaar incl. voering',          tKey: 'stad_b5' },
  { code: 'P0',  groep: 'ouders',     nl: 'P0 — Geen ouders aanwezig',              tKey: 'stad_p0' },
  { code: 'P1',  groep: 'ouders',     nl: 'P1 — Één ouder aanwezig',                tKey: 'stad_p1' },
  { code: 'P2',  groep: 'ouders',     nl: 'P2 — Beide ouders aanwezig',             tKey: 'stad_p2' },
  { code: 'P3',  groep: 'ouders',     nl: 'P3 — Polygamie',                         tKey: 'stad_p3' },
  { code: 'P4',  groep: 'ouders',     nl: 'P4 — Ouder broedend',                    tKey: 'stad_p4' },
  { code: 'P5',  groep: 'ouders',     nl: 'P5 — Alarmerend paar aanwezig',          tKey: 'stad_p5' },
  { code: 'P6',  groep: 'ouders',     nl: 'P6 — Geen alarmerend paar aanwezig',     tKey: 'stad_p6' },
  ...
  { code: 'N+',  groep: 'pulli',      nl: 'N+ — Aantal onbekend',                   tKey: 'stad_nplus' },
  { code: 'N0',  groep: 'pulli',      nl: 'N0 — Net uitgekomen',                    tKey: 'stad_n0' },
  { code: 'N1',  groep: 'pulli',      nl: 'N1 — Naakt of in dons',                  tKey: 'stad_n1' },
  { code: 'N2',  groep: 'pulli',      nl: 'N2 — Blind',                             tKey: 'stad_n2' },
  { code: 'N3',  groep: 'pulli',      nl: 'N3 — Ogen open',                         tKey: 'stad_n3' },
  { code: 'N4',  groep: 'pulli',      nl: 'N4 — Slagpennen in pin',                 tKey: 'stad_n4' },
  { code: 'N5',  groep: 'pulli',      nl: 'N5 — Slagpennen uit bloedspoel',         tKey: 'stad_n5' },
  { code: 'N6',  groep: 'pulli',      nl: 'N6 — Slagpennen half volgroeid',         tKey: 'stad_n6' },
  { code: 'N7',  groep: 'pulli',      nl: 'N7 — Klaar om uit te vliegen',           tKey: 'stad_n7' },
  { code: 'N8',  groep: 'pulli',      nl: 'N8 — Bijna vliegvaardig',                tKey: 'stad_n8' },
  { code: 'N9',  groep: 'pulli',      nl: 'N9 — Uitgevlogen op controledag',        tKey: 'stad_n9' },
  { code: 'N10', groep: 'pulli',      nl: 'N10 — Pas uitgevlogen, amper vliegvaardig', tKey: 'stad_n10' },
  { code: 'N11', groep: 'pulli',      nl: 'N11 — Pas uitgevlogen, vliegvaardig',    tKey: 'stad_n11' },
  { code: 'C1',  groep: 'nacontrole', nl: 'C1 — Succesvol; eieren/dode jongen achtergebleven', tKey: 'stad_c1' },
  { code: 'C2',  groep: 'nacontrole', nl: 'C2 — Succesvol; vliegvlugge jongen achtergebleven', tKey: 'stad_c2' },
  { code: 'C3',  groep: 'nacontrole', nl: 'C3 — Succesvol; geheel leeg nest',       tKey: 'stad_c3' },
  { code: 'C4',  groep: 'nacontrole', nl: 'C4 — Succesvol; geen nacontrole',        tKey: 'stad_c4' },
  { code: 'C5',  groep: 'nacontrole', nl: 'C5 — Mislukt; nest leeg/vernield/verdwenen', tKey: 'stad_c5' },
  { code: 'C6',  groep: 'nacontrole', nl: 'C6 — Mislukt; kapotte/verlaten eieren',  tKey: 'stad_c6' },
  { code: 'C7',  groep: 'nacontrole', nl: 'C7 — Mislukt; alle jongen dood',         tKey: 'stad_c7' },
  { code: 'C8',  groep: 'nacontrole', nl: 'C8 — Nest niet teruggevonden',           tKey: 'stad_c8' },
  { code: 'C9',  groep: 'nacontrole', nl: 'C9 — Broedsucces onduidelijk',           tKey: 'stad_c9' },
  { code: 'X0',  groep: 'overig',     nl: 'X0 — Niet gebruiken / onjuist',          tKey: 'stad_x0' },
];
