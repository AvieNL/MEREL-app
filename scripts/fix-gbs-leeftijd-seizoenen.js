/**
 * fix-gbs-leeftijd-seizoenen.js
 * Herschrijft leeftijds_notities_vj van de Grote Bonte Specht (08760):
 * - Seizoenscontinuïteit correct weergegeven: [4 herfst] → [5 vj], [5 herfst] → [7 vj], [7 herfst] → [9 vj]
 * - Voorjaar [5 vj] toont nu het juiste beeld (contrasterende LC/MC, géén versleten juv PC)
 * - Voorjaar [7 vj] toont het beeld van aangehouden juv PC/S (= herfst [5])
 * - 4e kj [9 vj] toegevoegd als pendant van herfst [7]
 * - Kruisverwijzingen zichtbaar gemaakt via "(= vorig najaar: ...)" en "→ in januari: ..."
 */
...
console.log('✓ Grote Bonte Specht leeftijdstekst seizoenscontinuïteit gecorrigeerd');
