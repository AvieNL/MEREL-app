/**
 * seed-heggenmus-determinatie.js
 * Laad determinatiehulpen voor Heggenmus (10840) in Supabase.
  ...
  // ── Leeftijdsbepaling ──────────────────────────────────────────────────────
  {
    ...
    stappen: {
      ...
      gc_vlekken_nj: {
        ...
        toelichting: 'Juveniele GC hebben duidelijke geelachtige vlekken op beide wimpels met een duidelijke zwarte punt. Met slijtage worden de geelachtige vlekken witachtig. Gemoulte GC hebben onduidelijkere vlekken die geleidelijk overgaan in de zwarte punt en bruinachtige rand. Let op: ruigrens is vaak moeilijk te vinden en kan ontbreken.',
        opties: [
          {
            waarde: 'duidelijk',
          ...
          },
          {
            ...
            resultaat: {
              ...
              label: 'na 1e kj',
              zeker: false,
              uitleg: 'Onduidelijke GC-vlekken duiden op na 1e kj (4). Iris lichter roodbruin (soms lichtbruin, soms even grijsachtig als bij 1e kj). Doorgaans witachtige vlekken op buitenste GC, weinig of geen op binnenste. Geen contrast tussen T en S. MC zonder geelachtige punt.',
            },
          },
          {
            waarde: 'onzeker',
...
console.log('\n✓ Heggenmus determinatiehulpen opgeslagen in Supabase');
