/**
 * seed-groenling-determinatie.js
 * Voegt de determinatiehulpen voor de Groenling (EURING 16490) toe aan
 * de Supabase determinatie_aid tabel.
 *
 * Gebruik: node scripts/seed-groenling-determinatie.js
 */
...
const leeftijdAid = {
  ...
  stappen: {
    ...
    ruigrens_detail_nj: {
      ...
      toelichting: 'Bij ♂ M: geruidde alula/CC met heldere gele rand en donker centrum vs. bruine juveniele handpendekveren. Geruid deel alula 1 in dezelfde gele kleur als aangrenzende kleine dekveren. Bij ♀ V: zelfde contrasten maar altijd minder opvallend; alula 1 groen i.p.v. geel.',
      opties: [
        {
          waarde: 'duidelijk',
...
console.log('✓ Groenling determinatiehulpen toegevoegd aan Supabase:');
